    ...
    <>
      ...
      <main className="vp-page pt-24">
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20 sm:py-28">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="vp-section-title mb-5">
                Build the future of commerce in Argentina
              </h1>
              <p className="text-lg text-[hsl(var(--vp-muted))] leading-relaxed max-w-2xl mx-auto">
                Join us in making professional POS tools accessible to every business. 
                We&apos;re a small, passionate team building something that matters.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 pb-16">
          <h2 className="vp-heading text-center mb-10">Why join VentaPlus?</h2>
        ...
        <section className="border-t border-[hsl(var(--vp-border))] bg-[hsl(var(--vp-bg-soft))]">
          <div className="max-w-7xl mx-auto px-6 py-16 sm:py-20">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="vp-heading mb-4">Open Positions</h2>
              <p className="text-[hsl(var(--vp-muted))] mb-10">
                We don&apos;t have open positions right now, but we&apos;re always looking for talented people.
              </p>
              <div className="vp-card p-8 text-center">
                ...
                <h3 className="text-lg font-semibold text-[hsl(var(--vp-text))] mb-2">Spontaneous Applications</h3>
                <p className="text-sm text-[hsl(var(--vp-muted))] mb-4 max-w-md mx-auto">
                  Think you'd be a great fit? Send us your CV and tell us why you'd like to join VentaPlus.
                </p>
