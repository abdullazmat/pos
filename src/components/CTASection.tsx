  ...
  return (
    <section id="cta" className="vp-section vp-reveal relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute -top-20 right-[-10%] h-72 w-72 rounded-full bg-[hsl(var(--vp-primary))]/15 blur-3xl" />
        <div className="absolute bottom-[-25%] left-[-5%] h-80 w-80 rounded-full bg-[hsl(var(--vp-primary))]/10 blur-[120px]" />
      </div>
