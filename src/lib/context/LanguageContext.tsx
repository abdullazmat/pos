...
const translationsEs = {
  ...
  ai: {
    ...
    insights: {
      ...
      growthDesc: "¡Excelente! Tus ingresos subieron un {growth}% esta semana.",
      stockOutVelocityTitle: "Agotamiento Inminente: {name}",
      stockOutVelocityDesc: "{name} se agotará en aprox. {days} días basado en tus ventas.",
      replenishNow: "Reponer Ahora",
      noStockTitle: "Sin Stock: {name}",
      noStockDesc: "Has perdido ventas potenciales de {name} por falta de inventario.",
      salesDropTitle: "Caída de Ventas Semanal",
      salesDropDesc: "Tus ventas bajaron un {drop}% comparado con la semana pasada.",
      weakestDayTitle: "Impulsa tu {day}",
      weakestDayDesc: "El {day} es tu día más bajo. Considera lanzar una promoción \"Flash\" ese día.",
      slowMovingTitle: "Producto Estancado",
      slowMovingDesc: "{name} no ha tenido ventas en 30 días. Considera un descuento del 15%.",
      editPrice: "Editar Precio",
      healthScoreTitle: "Salud del Negocio",
    },
    crossSell: {
      ...
      basedOnCart: "Basado en lo que llevas, te sugerimos:",
      addUpper: "AGREGAR",
    ...
    health: {
      ...
      stockEfficiency: "Eficiencia de Stock",
      rotationHealth: "Salud de Rotación",
    },
  },
  pos: {
    header: {
    ...
    ui: {
      ...
      keyboardPOSQuick: "Teclado POS (Carga Rápida)",
      keyboardPROHint: "La entrada rápida por teclado está disponible en planes superiores. Usa la búsqueda avanzada a continuación.",
      ...
      invalidQuantityDetail: "Cantidad inválida: {quantity}",
      quantityGreaterZero: "La cantidad debe ser mayor a cero",
      quantityTooLarge: "Cantidad demasiado grande. Máximo 100,000",
      productCodeRequiredAfterStar: "Se requiere el código de producto después de '*'",
      productCodeTooLong: "Código de producto demasiado largo",
      sessionExpired: "Sesión expirada. Por favor inicie sesión de nuevo.",
      productCodeEmpty: "El código de producto no puede estar vacío",
      invalidQuantityPositive: "Cantidad inválida: debe ser un número positivo",
      invalidProductData: "Datos de producto inválidos recibidos",
      invalidPriceForProduct: "Precio inválido para el producto: {name}",
      invalidServerResponse: "Respuesta del servidor inválida",
      invalidProductsData: "Datos de productos inválidos",
      searchFailed: "Búsqueda fallida: {message}",
      failedChangeCustomer: "Error al cambiar tipo de cliente",
      failedSearchCustomer: "Error al buscar cliente",
      failedCreateCustomer: "Error al crear nuevo cliente",
      failedRemoveCustomer: "Error al quitar cliente",
      defaultQuantity: "(Por defecto: 1)",
      proBadge: "🔒 PRO",
  ...
  purchaseOrders: {
    ...
    table: { number: "Número", supplier: "Proveedor", date: "Fecha", status: "Estado", items: "Ítems", totalEst: "Total Est.", actions: "Acciones", send: "Enviar", receive: "Recibir", noOrders: "Sin órdenes de compra", noOrdersSubtitle: "Crea tu primera orden con sugerencias inteligentes", code: "Código" },
...
const translationsEn = {
  ...
  ai: {
    ...
    insights: {
      ...
      growthDesc: "Excellent! Your revenue increased by {growth}% this week.",
      stockOutVelocityTitle: "Imminent Stock-out: {name}",
      stockOutVelocityDesc: "{name} will run out in approx. {days} days based on your sales.",
      replenishNow: "Replenish Now",
      noStockTitle: "Out of Stock: {name}",
      noStockDesc: "You lost potential sales of {name} due to lack of inventory.",
      salesDropTitle: "Weekly Sales Drop",
      salesDropDesc: "Your sales decreased by {drop}% compared to last week.",
      weakestDayTitle: "Boost your {day}",
      weakestDayDesc: "{day} is your slowest day. Consider launching a \"Flash\" promotion that day.",
      slowMovingTitle: "Stagnant Product",
      slowMovingDesc: "{name} has had no sales in 30 days. Consider a 15% discount.",
    ...
    crossSell: {
      ...
      basedOnCart: "Based on what you're taking, we suggest:",
      addUpper: "ADD",
      closeSale: "Complete Sale",
    },
    health: {
      salesGrowth: "Sales Growth",
      marginBalance: "Margin Balance",
      stockEfficiency: "Stock Efficiency",
  ...
  pos: {
    ...
    ui: {
      ...
      // Keyboard POS translations
      keyboardPOSQuick: "Keyboard POS (Quick Entry)",
      keyboardPROHint: "Quick keyboard entry is available on higher plans. Use the advanced search below.",
      ...
      invalidQuantityDetail: "Invalid quantity: {quantity}",
      quantityGreaterZero: "Quantity must be greater than zero",
      quantityTooLarge: "Quantity too large. Maximum 100,000",
      productCodeRequiredAfterStar: "Product code is required after '*'",
      productCodeTooLong: "Product code too long",
      sessionExpired: "Session expired. Please login again.",
      productCodeEmpty: "Product code cannot be empty",
      invalidQuantityPositive: "Invalid quantity: must be a positive number",
      invalidProductData: "Invalid product data received",
      invalidPriceForProduct: "Invalid price for product: {name}",
      invalidServerResponse: "Invalid response from server",
      invalidProductsData: "Invalid products data",
      searchFailed: "Search failed: {message}",
      failedChangeCustomer: "Failed to change customer type",
      failedSearchCustomer: "Failed to search customer",
      failedCreateCustomer: "Failed to create new customer",
      failedRemoveCustomer: "Failed to remove customer",
      defaultQuantity: "(Default: 1)",
      proBadge: "🔒 PRO",
...
const translationsPt = {
  ...
  ai: {
    ...
    insights: {
      ...
      growthDesc: "Excelente! Sua receita aumentou {growth}% esta semana.",
      stockOutVelocityTitle: "Esgotamento Iminente: {name}",
      stockOutVelocityDesc: "{name} se esgotará em aprox. {days} dias baseado em suas vendas.",
      replenishNow: "Repor Agora",
      noStockTitle: "Sem Estoque: {name}",
      noStockDesc: "Você perdeu vendas potenciais de {name} por falta de inventário.",
      salesDropTitle: "Queda de Vendas Semanal",
      salesDropDesc: "Suas vendas baixaram {drop}% comparado com a semana passada.",
      weakestDayTitle: "Impulsione seu {day}",
      weakestDayDesc: "{day} é o seu dia mais baixo. Considere lançar uma promoção \"Flash\" nesse dia.",
      slowMovingTitle: "Produto Estagnado",
      slowMovingDesc: "{name} não teve vendas em 30 dias. Considere um desconto de 15%.",
      editPrice: "Editar Preço",
      healthScoreTitle: "Saúde do Negócio",
    },
    crossSell: {
      ...
      somethingElse: "Mais alguma coisa?",
      basedOnCart: "Com base no que você está levando, sugerimos:",
      addUpper: "ADICIONAR",
      closeSale: "Fechar Venda",
    },
    health: {
      salesGrowth: "Crescimento de Vendas",
      marginBalance: "Equilíbrio de Margem",
      stockEfficiency: "Eficiência de Estoque",
      rotationHealth: "Saúde de Rotação",
    }
  },
  purchaseOrders: {
    ...
    create: { title: "Nova Ordem de Compra", subtitle: "Use sugestões de IA ou adicione produtos manualmente", generalInfo: "Informação Geral", supplier: "Fornecedor *", selectSupplier: "Selecionar fornecedor", deliveryDate: "Entrega Estimada", warehouse: "Almoxarifado / Filial", warehousePlaceholder: "Filial Principal", notes: "Notas", notesPlaceholder: "Notas opcionales", aiSuggestions: "Sugestões Inteligentes", coverage: "Cobertura:", days: "{count} dias", generate: "Gerar", analyzing: "Analisando...", suggestedProducts: "{count} produtos sugeridos", addAll: "+ Adicionar todos", manualAdd: "Adicionar Manual", selectProduct: "Selecionar produto", quantity: "Quantidade", cost: "Custo", add: "Adicionar", summary: "Resumo", totalUnits: "Unidades", totalEstimated: "Total Estimado", createButton: "Criar Ordem", unitAbr: "unid", aiPill: "IA", noSuggestions: "Nenhuma sugestão encontrada para este fornecedor.", noSuggestionsSubtitle: "Vincular produtos a este fornecedor ou registrar mais vendas ajudará a IA.", unlinkedWarning: "Este produto não está vinculado a este fornecedor.", autoLinkCheckbox: "Vincular produto ao fornecedor (salvar custo e prazo de entrega)" },
  ...
  pos: {
    ...
    ui: {
      ...
      // Keyboard POS translations
      keyboardPOSQuick: "Teclado PDV (Entrada Rápida)",
      keyboardPROHint: "A entrada rápida pelo teclado está disponível em planos superiores. Use a busca avançada abaixo.",
      ...
      invalidQuantityDetail: "Quantidade inválida: {quantity}",
      quantityGreaterZero: "A quantidade deve ser maior que zero",
      quantityTooLarge: "Quantidade muito grande. Máximo 100.000",
      productCodeRequiredAfterStar: "Código do produto é obrigatório após '*'",
      productCodeTooLong: "Código do produto muito longo",
      sessionExpired: "Sessão expirada. Por favor, faça login novamente.",
      productCodeEmpty: "O código do produto não pode estar vazio",
      invalidQuantityPositive: "Quantidade inválida: deve ser um número positivo",
      invalidProductData: "Dados do produto inválidos recebidos",
      invalidPriceForProduct: "Preço inválido para o produto: {name}",
      invalidServerResponse: "Resposta inválida do servidor",
      invalidProductsData: "Dados de produtos inválidos",
      searchFailed: "Busca falhou: {message}",
      failedChangeCustomer: "Erro ao mudar tipo de cliente",
      failedSearchCustomer: "Erro ao buscar cliente",
      failedCreateCustomer: "Erro ao criar novo cliente",
      failedRemoveCustomer: "Erro ao remover cliente",
      defaultQuantity: "(Padrão: 1)",
      proBadge: "🔒 PRO",
